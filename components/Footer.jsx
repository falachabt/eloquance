...
<footer className="p-4 bg-[#193A5D] sm:p-6 dark:bg-gray-800">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <Link href="/" className="flex  text-white items-center">
                    <img src="/assets/logo.svg" className=" w-36 " alt="Complétude Logo" />
                    </Link>
            </div>
                ...
                <div>
                    ...
                    <ul className="text-gray-200 dark:text-gray-200">
                        <li className="mb-4 flex items-center gap-5 ">
                             <MailOutlined/> 
                            <a href="#" className="hover:underline">cometecameroun@gmail.com</a>
                        </li>
                        <li className="mb-4 flex items-center gap-5" >
                             <PhoneOutlined/> 
                            <a href="#" className="hover:underline">694650142 / 651055663 </a>
                        </li>
                        <li className="mb-4 flex items-center gap-4 ">
                             <PhoneOutlined/> 
                            <a href="#" className="hover:underline">695051893 / 658959491S </a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-200">© 2024 <a href="/" className="hover:underline">Comète™</a>. All Rights Reserved.
            </span>
