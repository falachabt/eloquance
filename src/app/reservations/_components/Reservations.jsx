...
import { Form, Input, Button, Card, Typography, Layout, Steps, message, Divider, Flex } from 'antd';
    ...
    },
    {
      ...
      content: (
        <div id='canvas' >
          ...
          <Divider />
          {participants.map((participant, index) => (
              <p className='  p-4 py-2 border rounded ' > {participant.name}</p>
          ...
          <Form.Item>
            <Button type="primary" onClick={ async () => {  
              ...
              await handlePayment(participants, emailInCookies) } } block>
              Payer 
            </Button>
          </Form.Item>
        </div>
